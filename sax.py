# -*- coding: utf-8 -*-
"""
Created on Wed Sep 14 09:34:16 2016
...
class SAX(object):
    ...
    def __init__(self, wordSize = 8, alphabetSize = 7, epsilon = 1e-6):
        ...
        if alphabetSize < 3 or alphabetSize > 26:
        ...
        self.breakpoints = {'3' : [-0.43, 0.43],
                            ...
                            '26': [ -1.84, -1.68, -1.52, -1.36, -1.2 , -1.04, -0.88, -0.72, -0.56, -0.4 , -0.24, -0.08,  0.08,  0.24,  0.4 ,  0.56,  0.72, 0.88,  1.04,  1.2 ,  1.36,  1.52,  1.68,  1.84 ]
                            }
...
if __name__ == "__main__":
    ...
    ts = np.random.rand(100000) *  np.random.rand(100000) 

    res = SAX( 10 )
    a = res.alphabetize( res.to_PAA(ts)[0] )
